...
console.log(dePalabrasAFrase(["Hola", "Mundo", "Como estan?"]));
...
function promedioResultadosTest(resultadosTest) {
    ...
    return Number.parseInt((element / resultadosTest.length));
}
    ...
    for (let i = 0; i < array.length; i++) {
        switch (array[i]) {
            ...
            case "Noviembre":
                ...
                break;
            default:
                menssage = "No se encontraron los meses pedidos";
                break;
        }
    }
